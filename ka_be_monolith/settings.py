"""
Django settings for ka_be_monolith project.
...
ROOT_URLCONF = 'ka_be_monolith.urls'
...
WSGI_APPLICATION = 'ka_be_monolith.wsgi.application'
...
# DEFAULT_TABLESPACE = 'ka_be_monolith'
...
REST_FRAMEWORK = {
    ...
    # 'EXCEPTION_HANDLER': 'ka_be_monolith.api.utils.exceptions.custom_exception_handler',
    # 'DEFAULT_PAGINATION_CLASS': 'ka_be_monolith.api.framework.pagination.CustomPagination',
    # 'PAGE_SIZE': 10,
    'MAX_PAGE_SIZE': 1500,
